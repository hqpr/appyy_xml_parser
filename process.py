...
# python process.py pdf.pdf new.xml  -xml
...
ABBYY_APPID = 'Platform'
ABBYY_PWD = '61aSIadHHlVNi3dBnEeApHzV'


def setup_processor():
    processor.ApplicationId = ABBYY_APPID

    processor.Password = ABBYY_PWD
